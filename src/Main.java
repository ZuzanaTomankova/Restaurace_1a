...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        String fileName1 = "src/com/engeto/ja/Restaurant/Dish.txt";
        restaurantManager.saveDishToFile(dishList, fileName1);
        String fileName = "src/com/engeto/ja/Restaurant/Orders.txt";
        restaurantManager.saveOrdersToFile(ordersList, fileName,15);
